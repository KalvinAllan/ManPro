...
class FilterRatinggggg : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val profile = findViewById<ImageView>(R.id.profrate)
        ...
        btn.setOnClickListener {
            Log.d("kalkalkal", Tb.text.toString())
                val b = Intent(this@FilterRatinggggg,SearchActivity::class.java)
                b.putExtra("Di",Searchrtg.text.toString())
                startActivity(b)
        }
//        profile.setOnClickListener{
//            val b = Intent(this@FilterRatinggggg,Profile::class.java)
//            b.putExtra("usrname",text.toString())
//            startActivity(b)
//        }
        up.setOnClickListener {

                val b = Intent(this@FilterRatinggggg, FilterRatinggggg::class.java)
                Log.d("kalkalkal", Tb.text.toString())
        ...
        down.setOnClickListener {
            val b = Intent(this@FilterRatinggggg,FilterRatinggggggg::class.java)
            Log.d("kalkalkal",Tb.text.toString())
            b.putExtra("Rate",Tb.text.toString())
            startActivity(b)
        }
        ...
        filterNam.setOnClickListener{
            val b = Intent(this@FilterRatinggggg,FilterJarak::class.java)
            startActivity(b)
        }

        filterRat.setOnClickListener{
            val b = Intent(this@FilterRatinggggg,MainActivity::class.java)
            startActivity(b)
        }
    }
}